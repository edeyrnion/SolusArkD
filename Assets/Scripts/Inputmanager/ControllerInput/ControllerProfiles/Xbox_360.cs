...
namespace Matthias.Inputmanager
{
    ...
    {
        private void Xbox_360_Profile_Init()
        {
            profiles.Add("Controller (Xbox 360 For Windows)", Xbox_360_Profile);
            profiles.Add("Controller (Xbox 360 Wireless Receiver For Windows)", Xbox_360_Profile);
        }

        private void Xbox_360_Profile()
        {
            Name = "Xbox 360";
